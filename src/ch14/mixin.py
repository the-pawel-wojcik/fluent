...
def _upper(key):
    """ Try to uppercase, if fails return unchanged """
    try:
        return key.upper()
...
class UpperCaseMixin:
    """ A mixin class:
    sketchy, dynamic, multiple inheritance, python bussiness.
    """
    def __getitem__(self, key):
        # return super()[_upper(key)]  # does not work
        return super().__getitem__(_upper(key))

    def __setitem__(self, key, value):
        # super()[_upper(key)] = value  # does not work
